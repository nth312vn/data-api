# Tài liệu hệ thống Data API

Thư mục này chứa các tài liệu chi tiết mô tả về cách thiết kế, công nghệ sử dụng, và các luồng nghiệp vụ cốt lõi của dự án Backend Data API.

## Các tài liệu chính

Vui lòng tham khảo các tệp tin dưới đây để hiểu rõ hơn về hệ thống:
...
4. [Dynamic API (4-dynamic-api.md)](file:///d:/code/data-api/docs/4-dynamic-api.md): Hướng dẫn cấu hình dynamic API routes, typed parameters, và cơ chế PII mapping động (preset & custom).
